...
CREATE TABLE `medical_chart` (
  ...
  `check_doc` varchar(20) NOT NULL COMMENT '진료의',
  PRIMARY KEY (`chart_num`),
  KEY `medical_chart_employees_FK` (`check_doc`),
  CONSTRAINT `medical_chart_employees_FK` FOREIGN KEY (`check_doc`) REFERENCES `employees` (`EmployeeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patients` (
  ...
  PRIMARY KEY (`chart_num`),
  KEY `patients_employees_FK` (`main_doc`),
  CONSTRAINT `patients_medical_chart_FK` FOREIGN KEY (`chart_num`) REFERENCES `medical_chart` (`chart_num`),
  CONSTRAINT `patients_patient_admissions_FK` FOREIGN KEY (`chart_num`) REFERENCES `patient_admissions` (`chart_num`),
  CONSTRAINT `patients_patient_appointments_FK` FOREIGN KEY (`chart_num`) REFERENCES `patient_appointments` (`chart_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-05 19:16:06
